...
/** Parse input against schema and throw if invalid. */
...
/** Check if Figma is connected; return error if not. */
function checkFigmaConnection(figmaBridge: FigmaBridge): ToolResult | null {
